...
import com.example.prm392_project.databinding.FragmentDeliveredBinding;
...
public class DeliveredFragment extends Fragment {
    ...
    public static DeliveredFragment newInstance(String param1) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        orderViewModel.getOrders("Delivered", new OrderViewModel.OrdersCallback() {
            @Override
            public void onResult(List<com.example.prm392_project.data.model.main.order.Order> orders) {
                if (orders == null || orders.isEmpty()) {
                    ...
                    Collections.reverse(orders); // reverse list if needed
